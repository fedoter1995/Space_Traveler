...
namespace SpaceTraveler.GameStructures.Hits
{
    public class Hit
    {
        ...
        private HitDamage CalculateDamage(HitDamage damage)
        {
            ...
            var resultDamage = CalculateCritDamage(damage, multipliers, chances);

            return resultDamage;
        }
        private HitDamage CalculateCritDamage(HitDamage damage, List<Multiplier> multipliers, List<Chance> chances)
        {
